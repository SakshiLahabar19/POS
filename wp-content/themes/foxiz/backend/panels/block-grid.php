...
if ( ! function_exists( 'foxiz_register_options_block_grid_1' ) ) {
	...
	function foxiz_register_options_block_grid_1() {
		...
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the Grid 1 (standard). It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
					'class' => 'layout-info',
					'style' => 'success',
					'desc'  => html_entity_decode( '<img src="' . get_theme_file_uri( 'assets/images/' . str_replace( '_', '-', rtrim( $prefix, '_' ) ) . '.jpg' ) . '" alt="' . esc_attr__( 'grid', 'foxiz' ) . '">' ),
				),
				array(
...
if ( ! function_exists( 'foxiz_register_options_block_grid_2' ) ) {
	...
	function foxiz_register_options_block_grid_2() {
		...
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the grid 2 layout. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
...
if ( ! function_exists( 'foxiz_register_options_block_grid_small_1' ) ) {
	...
	function foxiz_register_options_block_grid_small_1() {
		...
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the small grid layout. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages)', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
					'class' => 'layout-info',
					'style' => 'success',
					'desc'  => html_entity_decode( '<img src="' . get_theme_file_uri( 'assets/images/' . str_replace( '_', '-', rtrim( $prefix, '_' ) ) . '.jpg' ) . '" alt="' . esc_attr__( 'small grid', 'foxiz' ) . '">' ),
				),
				array(
					'id'     => 'section_start_' . $prefix . 'featured',
					'type'   => 'section',
...
if ( ! function_exists( 'foxiz_register_options_block_grid_box_1' ) ) {
	...
	function foxiz_register_options_block_grid_box_1() {
		...
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the boxed grid 1. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
					'class' => 'layout-info',
					'style' => 'success',
					'desc'  => html_entity_decode( '<img src="' . get_theme_file_uri( 'assets/images/' . str_replace( '_', '-', rtrim( $prefix, '_' ) ) . '.jpg' ) . '" alt="' . esc_attr__( 'boxed grid', 'foxiz' ) . '">' ),
				),
				array(
					'id'     => 'section_start_' . $prefix . 'box_style',
					'type'   => 'section',
					'class'  => 'ruby-section-start',
					'title'  => esc_html__( 'Box Styles', 'foxiz' ),
					'indent' => true
				),
				array(
					'id'       => $prefix . 'box_style',
				...
				array(
					...
					'title'       => esc_html__( 'Dark - Box Color', 'foxiz' ),
					'subtitle'    => esc_html__( 'Select a color for the background or border style in the dark mode.', 'foxiz' ),
					'type'        => 'color',
					'transparent' => false
				),
				array(
...
if ( ! function_exists( 'foxiz_register_options_block_grid_box_2' ) ) {
	...
	function foxiz_register_options_block_grid_box_2() {
		...
		return array(
			...
			'icon'       => 'el el-th-large',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the boxed grid 2. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
