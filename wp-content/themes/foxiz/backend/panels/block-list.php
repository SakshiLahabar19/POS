...
if ( ! function_exists( 'foxiz_register_options_block_list_1' ) ) {
	...
	function foxiz_register_options_block_list_1() {
		...
		return array(
			...
			'title'      => esc_html__( 'List 1 (Standard)', 'foxiz' ),
			'icon'       => 'el el-th-list',
			'subsection' => true,
			'desc'       => html_entity_decode( esc_html__( 'These are settings for the list 1 (standard) layout. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ) ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
					'class' => 'layout-info',
					'style' => 'success',
					'desc'  => html_entity_decode( '<img src="' . get_theme_file_uri( 'assets/images/' . str_replace( '_', '-', rtrim( $prefix, '_' ) ) . '.jpg' ) . '" alt="' . esc_attr__( 'list', 'foxiz' ) . '">' ),
				),
				array(
				...
				array(
					...
					'title'    => esc_html__( 'Featured Position', 'foxiz' ),
...
if ( ! function_exists( 'foxiz_register_options_block_list_2' ) ) {
	...
	function foxiz_register_options_block_list_2() {
		...
		return array(
			...
			'icon'       => 'el el-th-list',
			'subsection' => true,
			'desc'       => esc_html__( 'These are settings for the list 2. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
...
if ( ! function_exists( 'foxiz_register_options_block_list_box_1' ) ) {
	...
	function foxiz_register_options_block_list_box_1() {
		...
		return array(
			...
			'icon'       => 'el el-th-list',
			'subsection' => true,
			'desc'       => html_entity_decode( esc_html__( 'These are settings for the boxed list 1. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ) ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
				...
				array(
					...
					'subtitle'    => esc_html__( 'Select a color for the background or border style in the dark mode or light scheme mode.', 'foxiz' ),
					'type'        => 'color',
					'transparent' => false
				),
				array(
...
if ( ! function_exists( 'foxiz_register_options_block_list_box_2' ) ) {
	...
	function foxiz_register_options_block_list_box_2() {
		...
		return array(
			...
			'icon'       => 'el el-th-list',
			'subsection' => true,
			'desc'       => html_entity_decode( esc_html__( 'These are settings for the boxed list 2. It will be overridden by the "Block Design" (for Elementor pages) and "Blog Design" (for the Blog and Archive pages).', 'foxiz' ) ),
			'fields'     => array(
				array(
					'id'    => $prefix . 'info',
					'type'  => 'info',
