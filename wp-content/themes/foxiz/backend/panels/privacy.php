...
if ( ! function_exists( 'foxiz_register_options_privacy' ) ) {
	function foxiz_register_options_privacy() {
		...
		return array(
			...
			'desc'   => esc_html__( 'Select options for the privacy notice bar.', 'foxiz' ),
			...
			'fields' => array(
				...
				array(
					...
					'subtitle' => esc_html__( 'Input your privacy or cookie content for your website, allow raw HTML.', 'foxiz' ),
				...
				array(
					...
					'subtitle'    => esc_html__( 'Select a color for this box background in the dark mode.', 'foxiz' ),
					'transparent' => false,
					'default'     => ''
				),
				array(
					...
					'subtitle'    => esc_html__( 'Select a color for the text in the dark mode.', 'foxiz' ),
					'transparent' => false,
					'default'     => ''
				),
			)
